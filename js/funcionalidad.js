    ...
    for(i=0; i<numcajas; i++){
        ...
        switch (colorcaj){
            ...
            case 'az': caj.style.backgroundColor='blue';
                break;
            case 'am': caj.style.backgroundColor='black';
                break;
            case 've': caj.style.backgroundColor='gray';
                break;   
            case 'vi': caj.style.backgroundColor='Purple';
                break;
        }
        switch (tipoborde){
...
function mostrarResultados(){
    ...
    var preg_1="¿Qué tipo de comida prefiere comer en la escuela?";
    var resp_1=document.getElementById("resp_1").value;
    var preg_2="¿Qué deporte práctica dentro del campus?";
    var resp_2=document.getElementById("resp_2").value;
    var preg_3="¿Cuál es su materia favorita?";
    var resp_3=document.getElementById("resp_3").value;
    var preg_4="¿Qué le gustaría que se incluyera en el campus?";
    var resp_4=document.getElementById("resp_4").value;
    var preg_5="¿Cómo llegas al campús?";
...
let mesas=function(){
    ...
    for(i=0; i<nm; i++){
        ...
        '<h4>Número de personas en la mesa</h4>'+
...
function nombreEnvia(){
    ...
    document.getElementById('nombre_envia_texto').style.fontSize="50px";
    document.getElementById('nombre_envia_texto').style.fontFamily= "Franklin Gothic Medium', 'Arial Narrow', Arial, sans-serif";
    localStorage.setItem('nom_e',nom_e);
    localStorage.setItem('nom_e_color',nom_e_color);
}

function nombreManda(){
    var nom_e=document.getElementById('nombre_manda').value;
    var nom_e_color=document.getElementById('color_nombre_manda').value;
    document.getElementById('nombre_manda_texto').innerHTML=nom_e;
    document.getElementById('nombre_manda_texto').style.color=nom_e_color;
    document.getElementById('nombre_manda_texto').style.fontSize="50px";
    document.getElementById('nombre_manda_texto').style.fontFamily= "Franklin Gothic Medium', 'Arial Narrow', Arial, sans-serif";
    localStorage.setItem('nom_e',nom_e);
    localStorage.setItem('nom_e_color',nom_e_color);
}
...
function saludoTexto(){
    ...
    document.getElementById('saludo_texto').style.fontSize="30px";
...
function cuerpoTexto(){
    ...
    document.getElementById('cuerpo_texto').style.fontSize="20px";
    document.getElementById('cuerpo_texto').style.fontStyle="Franklin Gothic Medium";
